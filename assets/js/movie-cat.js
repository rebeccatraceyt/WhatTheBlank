...
let movieScore;
let movieHighScore = sessionStorage.getItem("movieHighScore");
...
fetch("assets/js/questions/movies-questions.json")
    .then(res => {
        return res.json();
    })
    .then(loadedQuestions => {
        movieQuestions = loadedQuestions;
        startGame();
		startTimer();
    })
    .catch(err => {
